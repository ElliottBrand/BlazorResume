...
namespace BlazorResume.Server.Migrations
{
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GrayAreaSalary = table.Column<double>(type: "float", nullable: false),
                    TargetSalary = table.Column<double>(type: "float", nullable: false),
                    ShowHireinator = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Hireinator", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    MainThemeColor = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ShowNotice = table.Column<bool>(type: "bit", nullable: false),
                    NoticeText = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    EnableNoticeMarquee = table.Column<bool>(type: "bit", nullable: false),
